...
const (
	...
	ShipmentService_AddShipmentEvent_FullMethodName   = "/shipment.ShipmentService/AddShipmentEvent"
...
func (c *shipmentServiceClient) AddShipmentEvent(ctx context.Context, in *AddShipmentEventRequest, opts ...grpc.CallOption) (*AddShipmentEventResponse, error) {
	...
	err := c.cc.Invoke(ctx, ShipmentService_AddShipmentEvent_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shipmentServiceClient) GetShipmentHistory(ctx context.Context, in *GetShipmentHistoryRequest, opts ...grpc.CallOption) (*GetShipmentHistoryResponse, error) {
	...
	err := c.cc.Invoke(ctx, ShipmentService_GetShipmentHistory_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedShipmentServiceServer) AddShipmentEvent(context.Context, *AddShipmentEventRequest) (*AddShipmentEventResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddShipmentEvent not implemented")
}
